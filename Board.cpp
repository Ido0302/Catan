...
Edge* e0 = new Edge(vertices[0], vertices[1]); Edge* e1 = new Edge(vertices[1], vertices[2]); Edge* e2 = new Edge(vertices[2], vertices[3]); Edge* e3 = new Edge(vertices[3], vertices[4]); Edge* e4 = new Edge(vertices[4], vertices[5]); Edge* e5 = new Edge(vertices[5], vertices[0]);
Edge* e6 = new Edge(vertices[2], vertices[6]); Edge* e7 = new Edge(vertices[6], vertices[7]); Edge* e8 = new Edge(vertices[7], vertices[8]); Edge* e9 = new Edge(vertices[8], vertices[9]); Edge* e10 = new Edge(vertices[9], vertices[3]);
Edge* e11 = new Edge(vertices[7], vertices[10]); Edge* e12 = new Edge(vertices[10], vertices[11]); Edge* e13 = new Edge(vertices[11], vertices[12]); Edge* e14 = new Edge(vertices[12], vertices[13]); Edge* e15 = new Edge(vertices[13], vertices[8]);
Edge* e16 = new Edge(vertices[12], vertices[14]); Edge* e17 = new Edge(vertices[14], vertices[15]); Edge* e18 = new Edge(vertices[15], vertices[16]); Edge* e19 = new Edge(vertices[16], vertices[17]); Edge* e20 = new Edge(vertices[17], vertices[13]);
Edge* e21 = new Edge(vertices[17], vertices[18]); Edge* e22 = new Edge(vertices[18], vertices[19]); Edge* e23 = new Edge(vertices[19], vertices[9]);
Edge* e24 = new Edge(vertices[19], vertices[20]); Edge* e25 = new Edge(vertices[20], vertices[21]); Edge* e26 = new Edge(vertices[21], vertices[4]);
Edge* e27 = new Edge(vertices[21], vertices[22]); Edge* e28 = new Edge(vertices[22], vertices[23]); Edge* e29 = new Edge(vertices[23], vertices[16]); Edge* e30 = new Edge(vertices[16], vertices[5]);
Edge* e31 = new Edge(vertices[23], vertices[27]); Edge* e32 = new Edge(vertices[22], vertices[24]);
Edge* e33 = new Edge(vertices[24], vertices[25]); Edge* e34 = new Edge(vertices[25], vertices[26]); Edge* e35 = new Edge(vertices[26], vertices[27]);
Edge* e36 = new Edge(vertices[20], vertices[29]); Edge* e37 = new Edge(vertices[29], vertices[30]); Edge* e38 = new Edge(vertices[30], vertices[24]);
Edge* e39 = new Edge(vertices[18], vertices[31]); Edge* e40 = new Edge(vertices[31], vertices[32]); Edge* e41 = new Edge(vertices[32], vertices[29]);
Edge* e42 = new Edge(vertices[16], vertices[33]); Edge* e43 = new Edge(vertices[33], vertices[34]); Edge* e44 = new Edge(vertices[34], vertices[31]);
Edge* e45 = new Edge(vertices[15], vertices[35]); Edge* e46 = new Edge(vertices[35], vertices[36]); Edge* e47 = new Edge(vertices[36], vertices[37]); Edge* e48 = new Edge(vertices[37], vertices[33]);
Edge* e49 = new Edge(vertices[37], vertices[38]); Edge* e50 = new Edge(vertices[38], vertices[39]); Edge* e51 = new Edge(vertices[39], vertices[40]); Edge* e52 = new Edge(vertices[40], vertices[34]);
Edge* e53 = new Edge(vertices[40], vertices[41]); Edge* e54 = new Edge(vertices[41], vertices[42]); Edge* e55 = new Edge(vertices[42], vertices[32]);
Edge* e56 = new Edge(vertices[42], vertices[43]); Edge* e57 = new Edge(vertices[43], vertices[44]); Edge* e58 = new Edge(vertices[44], vertices[30]);
Edge* e59 = new Edge(vertices[44], vertices[45]); Edge* e60 = new Edge(vertices[45], vertices[46]); Edge* e61 = new Edge(vertices[46], vertices[25]);
Edge* e62 = new Edge(vertices[43], vertices[47]); Edge* e63 = new Edge(vertices[47], vertices[48]); Edge* e64 = new Edge(vertices[48], vertices[49]); Edge* e65 = new Edge(vertices[49], vertices[45]);
Edge* e66 = new Edge(vertices[41], vertices[50]); Edge* e67 = new Edge(vertices[50], vertices[51]); Edge* e68 = new Edge(vertices[51], vertices[47]);
Edge* e69 = new Edge(vertices[39], vertices[52]); Edge* e70 = new Edge(vertices[52], vertices[53]); Edge* e71 = new Edge(vertices[53], vertices[50]);
